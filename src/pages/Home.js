        ...
        <div className="flex flex-row pt-4 space-x-4 mx-4 ">
            ...
            <div className="container w-1/4 flex flex-col  pl-4 ">
                ...
                <div className="w-auto pt-4 ">
                    ...
                    <div className="border-gray-800 shadow p-4 rounded"> Recommended Jobs</div>
                    <div className="border-gray-800 shadow p-4 rounded"> Saved Jobs</div>
                    <div className="border-gray-800 shadow p-4 rounded"> Applied Jobs</div>
                    <div className="border-gray-800 shadow p-4 rounded"> Job Tracker</div>
                </div>
            </div>
            {/* *********************middle panel************ */}
