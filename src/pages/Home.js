    ...
    return (
        <div className="flex flex-row pt-4 space-x-4 mx-4 ">
            ...
            <div className=" mr-2 w-4/5">
                ...
                <div className=" w-auto px-4 h-52  py-4 space-y-4 bg-white shadow rounded-lg ">
                    <div className="shadow flex">
                        <input className="w-full rounded p-2 outline-none" type="text" placeholder="Search..." />
                        
                        <input className="h-8 pt-1" src="https://img.icons8.com/pastel-glyph/64/000000/search--v2.png" type="image" />
            ...
            <div className="w-2/6 h-auto bg-white rounded mt-2 shadow  ">
                ...
                <div className="bg-white-600 flex mr-3 justify-between h-28">
                    <div class="space-y-4">
                        ...
                        <p className=" capitalize font-semibold text-xl mx-3">UI/XI designer</p>
                ...
                <div className=" grid grid-cols-3 divide-x divide-gray-300  border-t-2 border-b-2">
                    <div className=" h-16 pl-2 shadow-sm">
                        <p>Experience</p>
                        <p className="text-xs mt-2 ">Minimum 6 months</p>
                    </div>
                    <div className=" h-16 pl-2 shadow-sm">
                        <p>Company</p>
                        <p className="text-xs mt-2">Information Tech...</p>
                    </div>
                    <div className=" h-16 pl-2 shadow-sm">
                        <p>Offer Salary</p>
                        <p className="text-xs mt-3">RS.5,00,000 P.A</p>
                    </div>
                </div>
