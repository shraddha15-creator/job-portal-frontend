    ...
    return (<div>
        <div className="flex bg-white  px-10 py-2  shadow justify-between  mt-2  text-sm">
            <div className="flex space-x-3    " >
                ...
                <div><h4 className="text-red-500 font-semibold text-lg ">Rohit Balodi</h4>
        ...
        <div className="flex bg-white  py-4   shadow justify-between w-full px-10   mt-4 text-base font-sans font-semibold">
