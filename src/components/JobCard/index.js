        ...
        <div className="bg-white border-b-2 border-r-2 border-l-2 border-solid border-gray-200 w-full ">
            <div className="flex  justify-between items-center">
                ...
                <div className="flex">
                    ...
                    <div className="ml-2 justify-around flex flex-col">
                        <div className="font-semibold text-blue-900 pt-2">{jobTitle}</div>
                        ...
                        <p className="text-gray-600 text-sm pt-4">lorem lipsum dolor sit amet, consectetur adipiscing elit.</p>
                        <div className="flex mr-20 flex-wrap pt-3 ">{details.map(detail => <div className=" font-medium text-sm pr-3" >{detail} </div>)}
                            <p className="flex ml-28  pb-4 text-blue-900 font-normal text-sm"> 1 Day </p>
                        </div>
