    ...
    return (<div className="bg-white shadow-dm   h-full   ">
        ...
        <div className="flex justify-between ">
            ...
            <img src="https://www.spamweed.com/wp-content/uploads/2017/02/site.png " class="rounded-3xl justify-center shadow-2xl w-12 h-12  mt-2 ml-2"></img>
               ...
               <p class="text-red-400 text-xl font-bold ml-2 mt-2">{jobTitle}</p>
               </div>
               <p class="underline text-xl mr-4 ">203 Applications</p>
        ...
        <div className="flex space-x-2 ml-12">
                         ...
                         <div className="font-semibold text-lg flex  ">{date}</div>
                    ...
                    <div className="flex space-x-3 text-lg mt-2 mb-4 font-thin ml-12 " ><p>Edit</p>
